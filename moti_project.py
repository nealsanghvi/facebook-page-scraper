...
def processFacebookPageStatus(status):
    ...
    if message_indicator == True: 
		return (status_id, status_message, message_indicator, link_name, status_type, status_link,
...
def scraper(page_id, access_token):
	with open('%s_facebook_statuses.csv' % page_id, 'wb') as file:
        w = csv.writer(file)
        w.writerow(["status_id", "status_message", "message indicator", "link_name", "status_type", "status_link",
           "status_published", "num_likes", "num_comments", "num_shares"])
